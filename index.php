      ...
      <div class="sidebar__area">
         <div class="sidebar__wrapper">
            <div class="sidebar__close">
               ...
               <span><i class="fal fa-times text-white"></i></span>
               <span>close</span>
               </button>
            </div>
      ...
      <section class="slider__area p-relative">
            <div class="slider__wrapper swiper-container">
               <div class="swiper-wrapper">
                 <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" data-background="assets/img/slider/home-banner-01.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                              <div class="slider__content">
                                 <span>We're up for deals</span>
                                 <h3 class="slider__title">Bring Business closer to its target market</h3>
                                 <a href="#" class="e-btn ms-3 bg-warning text-white slider__btn">Get a quote</a>
                                 <a href="contact" class="e-btn ms-3 bg-white text-dark slider__btn">Contact us</a>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <div class="banner__item p-relative mb-40">
                        <div class="banner__content">
                           ...
                           <h4 class="pt-115 text-center">
                           <a href="#"> Our Services  <i class="far fa-arrow-right"></i>
                               </a>
                           </h4>
         ...
         <!-- category area start -->
                <section class="course__area pt-115 pb-120 mb-20 grey-bg">
            <div class="container">
               ...
               <div class="row grid">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                     <div class="course__item  mb-30 fix shadow-none">
                        <div class="course__thumb w-img p-relative fix">
                           <a href="">
                              <img src="assets/img/course/web-dev.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content ">
                           <h3 class="course__title"><a href="">Web Design & Development</a></h3>
                           <p>Website design, Web development, eCommerce, Content Management System,Content Strategy, Web-based Systems, Corporate Websites.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                     <div class="course__item  mb-30 fix shadow-none">
                        <div class="course__thumb w-img p-relative fix">
                           <a href="">
                              <img src="assets/img/course/mobile-app.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content ">
                           <h3 class="course__title"><a href="">Mobile App Development</a></h3>
                           <p>Hybrid or Native App Development, Android and iOS App Development, Mobile Apps for Business, Commercial Apps Development, eCommerce.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                     <div class="course__item  mb-30 fix shadow-none">
                        <div class="course__thumb w-img p-relative fix">
                           <a href="">
                              <img src="assets/img/course/branding.jpg" alt="">
                           </a>
                        </div>
                        <div class="course__content ">
                           <h3 class="course__title"><a href="">Branding</a></h3>
                           <p>Logo Design, Brand Manual, Brand Guidelines, Corporate Identity, Stationeries,Company Profile, Brand Messaging, Brand Strategy</p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <section class="counter__area pt-145 pb-100">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3 col-sm-6">
                     <div class="section__title-wrapper text-center mb-60">
                        <h2 class="section__title">We are <span class="yellow-bg yellow-bg-big">Proud</span></h2>
                        <p>You don't have to struggle alone, you've got you covered</p>
                     </div>
                  </div>
               </div>
               <center>
               <div class="row">
                  <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-3 offset-md-0 col-sm-6 offset-sm-2">
                     <div class="counter__item mb-30 mb-5">
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                     <div class="counter__item counter__pl-80 mb-30 mb-5">
                        ...
                        <div class="counter__content">
                           <h4><span class="counter">55</span></h4>
                  ...
                  <div class="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item counter__pl-34 mb-30 mb-5">
               ...
               <div class="row align-items-end">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                     <div class="section__title-wrapper mb-45">
                        <h2  class='text-center'>Getting a website is very easy
                        </h2>
                     </div>
                  </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Get a quote</a></h4>
                           <p>write down the functionalities and behaviour of your desired website</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Talk to us</a></h4>
                           <p>Tell us the requirements and features of the website you want us to build for you. We know what to do.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">Credit us</a></h4>
                           <p>Once you makes payment and give us the necessary information. We'll start up your work</p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <!-- why area start -->
         <section class="why__area pt-125 mb-5 mb--120 mb-5">
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                     <div class="why__content pr-50 mt-40">
                        <div class="section__title-wrapper mb-30">
                           <span class="section__sub-title">Featured works</span>
                           <h2 class="section__title">Engage your customers with your fully functioning and well designed website.</h2>
                        </div>
         ...
         <!-- cta area start -->
         <section class="cta__area mb--120 mb-5 mt-5">
            <div class="container">
...
<!-- Mirrored from themepure.net/template/educal/educal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Apr 2022 08:15:12 GMT -->
</html>
